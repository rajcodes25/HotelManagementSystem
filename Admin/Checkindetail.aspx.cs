...
using System.Data;
public partial class Admin_Checkindetail : System.Web.UI.Page
{
    ...
    private void BindGridData()
    {
        try
        {
            SqlCommand cmd = new SqlCommand("SELECT bd.*,ar.Roomid,ar.rnum,ar.rprice,ar.rtype,ar.bedtype,ar.rcatg,ar.room_image FROM Bookdetail bd INNER JOIN Addroom ar ON bd.roomid = ar.Roomid WHERE status='CHECK IN'", con);
