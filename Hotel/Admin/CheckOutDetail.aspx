<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CheckOutDetail.aspx.cs" Inherits="Admin_CheckOutDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="">
            ...
            <br />
            <asp:TextBox ID="txtsearch" runat="server" AutoPostBack="true" Width="300px" Height="40px" Font-Bold="true" Font-Size="25px"></asp:TextBox>
        </div>
        <br />
