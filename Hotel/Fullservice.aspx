<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Fullservice.aspx.cs" Inherits="Fullservice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <asp:Label ID="lblserviceid" runat="server" Text="Label" Visible="false"></asp:Label>
    <br />
    <div class="container" style="border:">
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <div class="col-lg-12" style="margin-top:100px;display:flex">
                    <div style="border:" class="col-md-6">
                        <div class="col-sm-12" style="border:">
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("serviceimg","~/Admin/Serviceimg/{0}") %>' CssClass="room-image" Width="450px" Height="300px"/>
                     </div>
                        <br />
                  ...
                  <%--  <div class="col-sm-12" style="border:;">
                    ...
                    <div class="col-md-6" style="border:">
                        <div class="col-sm-12" style="border:">
                        <h2 style="text-align:center; font-size:50px"><%# Eval("servicename") %></h2>
                           <%-- <h2><%# Eval("blogtitle") %></h2>
                            <br />--%>
                            <h1 style="font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif"><%# Eval("servicedesc") %></h1>
    ...
    <div class="container">
        <center>
            <h1 style="font-family:'Bell MT'">OUR MORE SERVICES</h1>
        </center>
        <br />
         <div class="row" style="border:2px solid white" >
                <asp:Repeater ID="Repeater2" runat="server">
                  ...
                  <div class="blog_box">
                     <div class="blog_img">
                       <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='<%# Eval("serviceimg","~/Admin/Serviceimg/{0}") %>' Width="360px" Height="250px" CssClass="room-image"/>
                     </div>
                     <div class="blog_room" style="padding-bottom:50px">
                        ...
                        <%--<p><%# Eval("blogdesc") %> </p> <br />--%>
                          <a href="Fullservice.aspx?serviceid=<%# Eval("serviceid") %>" class="zoom-link" style="color:white; width:250px;height:40px; background-color:rgb(176 71 71);border:none;border-radius:4%;text-align:center">VIEW MORE</a>
